# M2 — deferred hard-tier harvest — deferral register

PARKED milestone register; stub + precondition = `.agent/roadmap.md`.
Every entry = an org whose compendium `swept` cell reads
`blocked(<why>)`.
