...
- cdc-2022-opioid | https://www.cdc.gov/mmwr/volumes/71/rr/pdfs/rr7103a1-H.pdf | in-progress (compendium row: Centers for Disease Control and Prevention, `id=cdc-2022-opioid`; 718 regions census-reconciled; counts = guideline README Coverage; pending, ordered: (1) ACE batches rec 6–12 impl — 107 pending impl regions, ~3 teammates, (2) pending-region rulings, (3) E-- coverage-closure extension of goal.py check)
