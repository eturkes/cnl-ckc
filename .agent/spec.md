...
- M5.7 cutover (contract `.agent/contracts/m5u7.md` P1–P6; fork shrink R95): CI swap; delete `vendor/e--`, `tools/`, `tests/strict`, `red.sh`; NOTICE/REFERENCE/README/rules scrub; release-manifest regen (R72). Accept: `git grep -iE 'e--|\.emm'` empty; new chain green.
