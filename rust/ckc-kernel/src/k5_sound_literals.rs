        ...
        u::copy_registry()[5] == u::lit("\n"@),
{
    ...
    assert(u::lit("\n"@) =~= bs![10u8,]);
    assert(cx::scan(bs![10u8,], ctx) == ctx);
    cx::exact(u::lit("\n"@), ctx);
    h::fixed(u::lit("\n"@), inputs, ctx, ctx);
}
        ...
        u::copy_registry()[6] == u::lit("<td>"@),
{
    ...
    assert(u::lit("<td>"@) =~= bs![60u8,116,100,62]);
    assert(cx::scan(bs![60u8,116,100,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("<td>"@), 0);
        ...
        u::copy_registry()[7] == u::lit("</td>"@),
{
    ...
    reveal_strlit("</td>");
    is_ascii_chars_encode_utf8("</td>"@);
    assert(u::lit("</td>"@) =~= bs![60u8,47,116,100,62]);
    assert(cx::scan(bs![60u8,47,116,100,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</td>"@), 0);
    h::fixed(u::lit("</td>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[8] == u::lit("<tr>"@),
{
    ...
    assert(u::lit("<tr>"@) =~= bs![60u8,116,114,62]);
    assert(cx::scan(bs![60u8,116,114,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("<tr>"@), 0);
        ...
        u::copy_registry()[9] == u::lit("</tr>"@),
{
    ...
    reveal_strlit("</tr>");
    is_ascii_chars_encode_utf8("</tr>"@);
    assert(u::lit("</tr>"@) =~= bs![60u8,47,116,114,62]);
    assert(cx::scan(bs![60u8,47,116,114,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</tr>"@), 0);
    h::fixed(u::lit("</tr>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[10] == u::lit("<a href=\""@),
{
    ...
    assert(u::lit("<a href=\""@) =~= bs![60u8,97,32,104,114,101,102,61,34]);
    assert(cx::scan(bs![60u8,97,32,104,114,101,102,61,34], 0) == 2) by (compute_only);
        ...
        u::copy_registry()[11] == u::lit("\">"@),
{
    ...
    reveal_strlit("\">");
    is_ascii_chars_encode_utf8("\">"@);
    assert(u::lit("\">"@) =~= bs![34u8,62]);
    assert(cx::scan(bs![34u8,62], 2) == 0) by (compute_only);
    cx::exact(u::lit("\">"@), 2);
        ...
        u::copy_registry()[12] == u::lit("</a>"@),
{
    ...
    assert(u::lit("</a>"@) =~= bs![60u8,47,97,62]);
    assert(cx::scan(bs![60u8,47,97,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</a>"@), 0);
        ...
        u::copy_registry()[23] == u::lit("<span class=\"chip chip-"@),
{
    ...
    assert(u::lit("<span class=\"chip chip-"@)
        =~= bs![60u8,115,112,97,110,32,99,108,97,115,115,61,34,99,104,105,112,32,99,104,105,112,45]);
    assert(cx::scan(
        bs![60u8,115,112,97,110,32,99,108,97,115,115,61,34,99,104,105,112,32,99,104,105,112,45],
        0,
    ) == 2) by (compute_only);
        ...
        u::copy_registry()[24] == u::lit("</span>"@),
{
    ...
    assert(u::lit("</span>"@) =~= bs![60u8,47,115,112,97,110,62]);
    assert(cx::scan(bs![60u8,47,115,112,97,110,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[29] == u::lit(" · "@),
{
    ...
    assert(encode_scalar(183u32) == bs![194u8,183]) by (compute_only);
    assert(cs[1] as u32 == 183);
    assert(u::lit(" · "@) =~= bs![32u8,194,183,32]);
    assert(cx::scan(bs![32u8,194,183,32], 0) == 0) by (compute_only);
    cx::exact(u::lit(" · "@), 0);
        ...
        u::copy_registry()[36] == u::lit(" "@),
{
    ...
    reveal_strlit(" ");
    is_ascii_chars_encode_utf8(" "@);
    assert(u::lit(" "@) =~= bs![32u8,]);
    assert(cx::scan(bs![32u8,], 0) == 0) by (compute_only);
    cx::exact(u::lit(" "@), 0);
    h::fixed(u::lit(" "@), inputs, 0, 0);
}
        ...
        u::copy_registry()[40] == u::lit("<!doctype html>"@),
{
    ...
    assert(u::lit("<!doctype html>"@)
        =~= bs![60u8,33,100,111,99,116,121,112,101,32,104,116,109,108,62]);
    assert(cx::scan(bs![60u8,33,100,111,99,116,121,112,101,32,104,116,109,108,62], 0) == 0)
        by (compute_only);
        ...
        u::copy_registry()[41] == u::lit("<html lang=\"en\">"@),
{
    ...
    assert(u::lit("<html lang=\"en\">"@)
        =~= bs![60u8,104,116,109,108,32,108,97,110,103,61,34,101,110,34,62]);
    assert(cx::scan(bs![60u8,104,116,109,108,32,108,97,110,103,61,34,101,110,34,62], 0) == 0)
        by (compute_only);
        ...
        u::copy_registry()[42] == u::lit("<head>"@),
{
    ...
    assert(u::lit("<head>"@) =~= bs![60u8,104,101,97,100,62]);
    assert(cx::scan(bs![60u8,104,101,97,100,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[43] == u::lit("<meta charset=\"utf-8\">"@),
{
    ...
    assert(u::lit("<meta charset=\"utf-8\">"@)
        =~= bs![60u8,109,101,116,97,32,99,104,97,114,115,101,116,61,34,117,116,102,45,56,34,62]);
    assert(cx::scan(
        bs![60u8,109,101,116,97,32,99,104,97,114,115,101,116,61,34,117,116,102,45,56,34,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[44] == u::lit("<title>"@),
{
    ...
    assert(u::lit("<title>"@) =~= bs![60u8,116,105,116,108,101,62]);
    assert(cx::scan(bs![60u8,116,105,116,108,101,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[45] == u::lit(" — cnl-ckc reviewer</title>"@),
{
    ...
    encode_utf8_concat(cs.take(1) + seq![cs[1]], cs.skip(2));
    reveal_with_fuel(encode_utf8, 2);
    assert(encode_scalar(8212u32) == bs![226u8,128,148]) by (compute_only);
    assert(cs[1] as u32 == 8212);
    assert(u::lit(" — cnl-ckc reviewer</title>"@)
        =~= bs![32u8,226,128,148,32,99,110,108,45,99,107,99,32,114,101,118,105,101,119,101,114,60,47,116,105,116,108,101,62]);
    assert(cx::scan(
        bs![32u8,226,128,148,32,99,110,108,45,99,107,99,32,114,101,118,105,101,119,101,114,60,47,116,105,116,108,101,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[46] == u::lit("<style>"@),
{
    ...
    assert(u::lit("<style>"@) =~= bs![60u8,115,116,121,108,101,62]);
    assert(cx::scan(bs![60u8,115,116,121,108,101,62], 0) == 5) by (compute_only);
        ...
        u::copy_registry()[47] == u::lit("</style>"@),
{
    ...
    reveal_strlit("</style>");
    is_ascii_chars_encode_utf8("</style>"@);
    assert(u::lit("</style>"@) =~= bs![60u8,47,115,116,121,108,101,62]);
    assert(cx::scan(bs![60u8,47,115,116,121,108,101,62], 5) == 0) by (compute_only);
        ...
        u::copy_registry()[48] == u::lit("</head>"@),
{
    ...
    reveal_strlit("</head>");
    is_ascii_chars_encode_utf8("</head>"@);
    assert(u::lit("</head>"@) =~= bs![60u8,47,104,101,97,100,62]);
    assert(cx::scan(bs![60u8,47,104,101,97,100,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</head>"@), 0);
    h::fixed(u::lit("</head>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[49] == u::lit("<body>"@),
{
    ...
    assert(u::lit("<body>"@) =~= bs![60u8,98,111,100,121,62]);
    assert(cx::scan(bs![60u8,98,111,100,121,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[50] == u::lit("<a class=\"skip\" href=\"#main\">Skip to content</a>"@),
{
    ...
    assert(u::lit("<a class=\"skip\" href=\"#main\">Skip to content</a>"@)
        =~= bs![60u8,97,32,99,108,97,115,115,61,34,115,107,105,112,34,32,104,114,101,102,61,34,35,109,97,105,110,34,62,83,107,105,112,32,116,111,32,99,111,110,116,101,110,116,60,47,97,62]);
    assert(cx::scan(
        bs![60u8,97,32,99,108,97,115,115,61,34,115,107,105,112,34,32,104,114,101,102,61,34,35,109,97,105,110,34,62,83,107,105,112,32,116,111,32,99,111,110,116,101,110,116,60,47,97,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[51] == u::lit("<nav class=\"crumbs\">"@),
{
    ...
    assert(u::lit("<nav class=\"crumbs\">"@)
        =~= bs![60u8,110,97,118,32,99,108,97,115,115,61,34,99,114,117,109,98,115,34,62]);
    assert(cx::scan(bs![60u8,110,97,118,32,99,108,97,115,115,61,34,99,114,117,109,98,115,34,62], 0)
        == 0) by (compute_only);
        ...
        u::copy_registry()[52] == u::lit("</nav>"@),
{
    ...
    assert(u::lit("</nav>"@) =~= bs![60u8,47,110,97,118,62]);
    assert(cx::scan(bs![60u8,47,110,97,118,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[53] == u::lit("<main id=\"main\">"@),
{
    ...
    assert(u::lit("<main id=\"main\">"@)
        =~= bs![60u8,109,97,105,110,32,105,100,61,34,109,97,105,110,34,62]);
    assert(cx::scan(bs![60u8,109,97,105,110,32,105,100,61,34,109,97,105,110,34,62], 0) == 0)
        by (compute_only);
        ...
        u::copy_registry()[54] == u::lit("</main>"@),
{
    ...
    assert(u::lit("</main>"@) =~= bs![60u8,47,109,97,105,110,62]);
    assert(cx::scan(bs![60u8,47,109,97,105,110,62], 0) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit(
        ...
        =~= bs![60u8,102,111,111,116,101,114,32,99,108,97,115,115,61,34,115,99,111,112,101,34,62,60,112,62,84,104,105,115,32,112,97,103,101,32,114,101,112,111,114,116,115,32,119,104,97,116,32,116,104,101,32,108,111,97,100,101,100,32,103,117,105,100,101,108,105,110,101,32,100,111,99,117,109,101,110,116,115,32,115,116,97,116,101,46,32,73,116,32,100,111,101,115,32,110,111,116,32,103,105,118,101,32,99,108,105,110,105,99,97,108,32,97,100,118,105,99,101,46,60,47,112,62,60,47,102,111,111,116,101,114,62]);
    assert(cx::scan(
        bs![60u8,102,111,111,116,101,114,32,99,108,97,115,115,61,34,115,99,111,112,101,34,62,60,112,62,84,104,105,115,32,112,97,103,101,32,114,101,112,111,114,116,115,32,119,104,97,116,32,116,104,101,32,108,111,97,100,101,100,32,103,117,105,100,101,108,105,110,101,32,100,111,99,117,109,101,110,116,115,32,115,116,97,116,101,46,32,73,116,32,100,111,101,115,32,110,111,116,32,103,105,118,101,32,99,108,105,110,105,99,97,108,32,97,100,118,105,99,101,46,60,47,112,62,60,47,102,111,111,116,101,114,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[56] == u::lit("</body>"@),
{
    ...
    reveal_strlit("</body>");
    is_ascii_chars_encode_utf8("</body>"@);
    assert(u::lit("</body>"@) =~= bs![60u8,47,98,111,100,121,62]);
    assert(cx::scan(bs![60u8,47,98,111,100,121,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</body>"@), 0);
    h::fixed(u::lit("</body>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[57] == u::lit("</html>"@),
{
    ...
    assert(u::lit("</html>"@) =~= bs![60u8,47,104,116,109,108,62]);
    assert(cx::scan(bs![60u8,47,104,116,109,108,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[78] == u::lit("cnl-ckc reviewer"@),
{
    ...
    assert(u::lit("cnl-ckc reviewer"@)
        =~= bs![99u8,110,108,45,99,107,99,32,114,101,118,105,101,119,101,114]);
    assert(cx::scan(bs![99u8,110,108,45,99,107,99,32,114,101,118,105,101,119,101,114], 0) == 0)
        by (compute_only);
        ...
        u::copy_registry()[79] == u::lit("<h1>Guidelines</h1>"@),
{
    ...
    assert(u::lit("<h1>Guidelines</h1>"@)
        =~= bs![60u8,104,49,62,71,117,105,100,101,108,105,110,101,115,60,47,104,49,62]);
    assert(cx::scan(bs![60u8,104,49,62,71,117,105,100,101,108,105,110,101,115,60,47,104,49,62], 0)
        == 0) by (compute_only);
        ...
        u::copy_registry()[80] == u::lit("<section>"@),
{
    ...
    assert(u::lit("<section>"@) =~= bs![60u8,115,101,99,116,105,111,110,62]);
    assert(cx::scan(bs![60u8,115,101,99,116,105,111,110,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[81] == u::lit("<table>"@),
{
    ...
    assert(u::lit("<table>"@) =~= bs![60u8,116,97,98,108,101,62]);
    assert(cx::scan(bs![60u8,116,97,98,108,101,62], 0) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit(
        ...
        =~= bs![60u8,116,104,101,97,100,62,60,116,114,62,60,116,104,62,71,117,105,100,101,108,105,110,101,60,47,116,104,62,60,116,104,62,68,111,99,117,109,101,110,116,115,60,47,116,104,62,60,116,104,62,80,97,115,115,97,103,101,115,60,47,116,104,62,60,116,104,62,65,112,112,114,111,118,101,100,60,47,116,104,62,60,116,104,62,82,101,106,101,99,116,101,100,60,47,116,104,62,60,116,104,62,67,111,110,116,101,115,116,101,100,60,47,116,104,62,60,116,104,62,79,117,116,100,97,116,101,100,60,47,116,104,62,60,116,104,62,85,110,114,101,118,105,101,119,101,100,60,47,116,104,62,60,47,116,114,62,60,47,116,104,101,97,100,62]);
    assert(cx::scan(
        bs![60u8,116,104,101,97,100,62,60,116,114,62,60,116,104,62,71,117,105,100,101,108,105,110,101,60,47,116,104,62,60,116,104,62,68,111,99,117,109,101,110,116,115,60,47,116,104,62,60,116,104,62,80,97,115,115,97,103,101,115,60,47,116,104,62,60,116,104,62,65,112,112,114,111,118,101,100,60,47,116,104,62,60,116,104,62,82,101,106,101,99,116,101,100,60,47,116,104,62,60,116,104,62,67,111,110,116,101,115,116,101,100,60,47,116,104,62,60,116,104,62,79,117,116,100,97,116,101,100,60,47,116,104,62,60,116,104,62,85,110,114,101,118,105,101,119,101,100,60,47,116,104,62,60,47,116,114,62,60,47,116,104,101,97,100,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[83] == u::lit("<tbody>"@),
{
    ...
    assert(u::lit("<tbody>"@) =~= bs![60u8,116,98,111,100,121,62]);
    assert(cx::scan(bs![60u8,116,98,111,100,121,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[84] == u::lit("</tbody>"@),
{
    ...
    reveal_strlit("</tbody>");
    is_ascii_chars_encode_utf8("</tbody>"@);
    assert(u::lit("</tbody>"@) =~= bs![60u8,47,116,98,111,100,121,62]);
    assert(cx::scan(bs![60u8,47,116,98,111,100,121,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</tbody>"@), 0);
    h::fixed(u::lit("</tbody>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[85] == u::lit("</table>"@),
{
    ...
    reveal_strlit("</table>");
    is_ascii_chars_encode_utf8("</table>"@);
    assert(u::lit("</table>"@) =~= bs![60u8,47,116,97,98,108,101,62]);
    assert(cx::scan(bs![60u8,47,116,97,98,108,101,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</table>"@), 0);
    h::fixed(u::lit("</table>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[86] == u::lit("</section>"@),
{
    ...
    reveal_strlit("</section>");
    is_ascii_chars_encode_utf8("</section>"@);
    assert(u::lit("</section>"@) =~= bs![60u8,47,115,101,99,116,105,111,110,62]);
    assert(cx::scan(bs![60u8,47,115,101,99,116,105,111,110,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</section>"@), 0);
    h::fixed(u::lit("</section>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[97] == u::lit("<h1>"@),
{
    ...
    assert(u::lit("<h1>"@) =~= bs![60u8,104,49,62]);
    assert(cx::scan(bs![60u8,104,49,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("<h1>"@), 0);
        ...
        u::copy_registry()[98] == u::lit("</h1>"@),
{
    ...
    reveal_strlit("</h1>");
    is_ascii_chars_encode_utf8("</h1>"@);
    assert(u::lit("</h1>"@) =~= bs![60u8,47,104,49,62]);
    assert(cx::scan(bs![60u8,47,104,49,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</h1>"@), 0);
    h::fixed(u::lit("</h1>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[99] == u::lit("<p>"@),
{
    ...
    assert(u::lit("<p>"@) =~= bs![60u8,112,62]);
    assert(cx::scan(bs![60u8,112,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("<p>"@), 0);
        ...
        ),
{
    ...
    assert(u::lit(" <a href=\"records.html\">All decision records</a></p>"@)
        =~= bs![32u8,60,97,32,104,114,101,102,61,34,114,101,99,111,114,100,115,46,104,116,109,108,34,62,65,108,108,32,100,101,99,105,115,105,111,110,32,114,101,99,111,114,100,115,60,47,97,62,60,47,112,62]);
    assert(cx::scan(
        bs![32u8,60,97,32,104,114,101,102,61,34,114,101,99,111,114,100,115,46,104,116,109,108,34,62,65,108,108,32,100,101,99,105,115,105,111,110,32,114,101,99,111,114,100,115,60,47,97,62,60,47,112,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[101] == u::lit("<h2>Status</h2>"@),
{
    ...
    assert(u::lit("<h2>Status</h2>"@)
        =~= bs![60u8,104,50,62,83,116,97,116,117,115,60,47,104,50,62]);
    assert(cx::scan(bs![60u8,104,50,62,83,116,97,116,117,115,60,47,104,50,62], 0) == 0)
        by (compute_only);
        ...
        u::copy_registry()[102] == u::lit("<table class=\"compact\">"@),
{
    ...
    assert(u::lit("<table class=\"compact\">"@)
        =~= bs![60u8,116,97,98,108,101,32,99,108,97,115,115,61,34,99,111,109,112,97,99,116,34,62]);
    assert(cx::scan(
        bs![60u8,116,97,98,108,101,32,99,108,97,115,115,61,34,99,111,109,112,97,99,116,34,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[103] == u::lit("<thead><tr><th>Status</th><th>Count</th></tr></thead>"@),
{
    ...
    assert(u::lit("<thead><tr><th>Status</th><th>Count</th></tr></thead>"@)
        =~= bs![60u8,116,104,101,97,100,62,60,116,114,62,60,116,104,62,83,116,97,116,117,115,60,47,116,104,62,60,116,104,62,67,111,117,110,116,60,47,116,104,62,60,47,116,114,62,60,47,116,104,101,97,100,62]);
    assert(cx::scan(
        bs![60u8,116,104,101,97,100,62,60,116,114,62,60,116,104,62,83,116,97,116,117,115,60,47,116,104,62,60,116,104,62,67,111,117,110,116,60,47,116,104,62,60,47,116,114,62,60,47,116,104,101,97,100,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[104] == u::lit("<h2>Documents</h2>"@),
{
    ...
    assert(u::lit("<h2>Documents</h2>"@)
        =~= bs![60u8,104,50,62,68,111,99,117,109,101,110,116,115,60,47,104,50,62]);
    assert(cx::scan(bs![60u8,104,50,62,68,111,99,117,109,101,110,116,115,60,47,104,50,62], 0) == 0)
        by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit(
        ...
        =~= bs![60u8,116,104,101,97,100,62,60,116,114,62,60,116,104,62,68,111,99,117,109,101,110,116,60,47,116,104,62,60,116,104,62,83,116,97,116,117,115,60,47,116,104,62,60,116,104,62,68,101,99,105,115,105,111,110,115,60,47,116,104,62,60,116,104,62,80,97,115,115,97,103,101,60,47,116,104,62,60,47,116,114,62,60,47,116,104,101,97,100,62]);
    assert(cx::scan(
        bs![60u8,116,104,101,97,100,62,60,116,114,62,60,116,104,62,68,111,99,117,109,101,110,116,60,47,116,104,62,60,116,104,62,83,116,97,116,117,115,60,47,116,104,62,60,116,104,62,68,101,99,105,115,105,111,110,115,60,47,116,104,62,60,116,104,62,80,97,115,115,97,103,101,60,47,116,104,62,60,47,116,114,62,60,47,116,104,101,97,100,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[106] == u::lit("<h2>Passages without ACE</h2>"@),
{
    ...
    assert(u::lit("<h2>Passages without ACE</h2>"@)
        =~= bs![60u8,104,50,62,80,97,115,115,97,103,101,115,32,119,105,116,104,111,117,116,32,65,67,69,60,47,104,50,62]);
    assert(cx::scan(
        bs![60u8,104,50,62,80,97,115,115,97,103,101,115,32,119,105,116,104,111,117,116,32,65,67,69,60,47,104,50,62],
        0,
    ) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit("<thead><tr><th>Passage</th><th>Status</th><th>Section</th></tr></thead>"@)
        =~= bs![60u8,116,104,101,97,100,62,60,116,114,62,60,116,104,62,80,97,115,115,97,103,101,60,47,116,104,62,60,116,104,62,83,116,97,116,117,115,60,47,116,104,62,60,116,104,62,83,101,99,116,105,111,110,60,47,116,104,62,60,47,116,114,62,60,47,116,104,101,97,100,62]);
    assert(cx::scan(
        bs![60u8,116,104,101,97,100,62,60,116,114,62,60,116,104,62,80,97,115,115,97,103,101,60,47,116,104,62,60,116,104,62,83,116,97,116,117,115,60,47,116,104,62,60,116,104,62,83,101,99,116,105,111,110,60,47,116,104,62,60,47,116,114,62,60,47,116,104,101,97,100,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[108] == u::lit("<a href=\"../../index.html\">guidelines</a> / "@),
{
    ...
    assert(u::lit("<a href=\"../../index.html\">guidelines</a> / "@)
        =~= bs![60u8,97,32,104,114,101,102,61,34,46,46,47,46,46,47,105,110,100,101,120,46,104,116,109,108,34,62,103,117,105,100,101,108,105,110,101,115,60,47,97,62,32,47,32]);
    assert(cx::scan(
        bs![60u8,97,32,104,114,101,102,61,34,46,46,47,46,46,47,105,110,100,101,120,46,104,116,109,108,34,62,103,117,105,100,101,108,105,110,101,115,60,47,97,62,32,47,32],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[113] == u::lit("<section id=\""@),
{
    ...
    assert(u::lit("<section id=\""@) =~= bs![60u8,115,101,99,116,105,111,110,32,105,100,61,34]);
    assert(cx::scan(bs![60u8,115,101,99,116,105,111,110,32,105,100,61,34], 0) == 2)
        by (compute_only);
        ...
        u::copy_registry()[114] == u::lit("<h2>"@),
{
    ...
    assert(u::lit("<h2>"@) =~= bs![60u8,104,50,62]);
    assert(cx::scan(bs![60u8,104,50,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("<h2>"@), 0);
        ...
        u::copy_registry()[115] == u::lit("</h2>"@),
{
    ...
    reveal_strlit("</h2>");
    is_ascii_chars_encode_utf8("</h2>"@);
    assert(u::lit("</h2>"@) =~= bs![60u8,47,104,50,62]);
    assert(cx::scan(bs![60u8,47,104,50,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</h2>"@), 0);
    h::fixed(u::lit("</h2>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[116] == u::lit("<table class=\"records\">"@),
{
    ...
    assert(u::lit("<table class=\"records\">"@)
        =~= bs![60u8,116,97,98,108,101,32,99,108,97,115,115,61,34,114,101,99,111,114,100,115,34,62]);
    assert(cx::scan(
        bs![60u8,116,97,98,108,101,32,99,108,97,115,115,61,34,114,101,99,111,114,100,115,34,62],
        0,
    ) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit(
        ...
        =~= bs![60u8,116,104,101,97,100,62,60,116,114,62,60,116,104,62,68,101,99,105,115,105,111,110,60,47,116,104,62,60,116,104,62,82,101,118,105,101,119,101,114,60,47,116,104,62,60,116,104,62,68,97,116,101,60,47,116,104,62,60,116,104,62,86,101,114,115,105,111,110,60,47,116,104,62,60,116,104,62,67,111,109,109,101,110,116,60,47,116,104,62,60,47,116,114,62,60,47,116,104,101,97,100,62]);
    assert(cx::scan(
        bs![60u8,116,104,101,97,100,62,60,116,114,62,60,116,104,62,68,101,99,105,115,105,111,110,60,47,116,104,62,60,116,104,62,82,101,118,105,101,119,101,114,60,47,116,104,62,60,116,104,62,68,97,116,101,60,47,116,104,62,60,116,104,62,86,101,114,115,105,111,110,60,47,116,104,62,60,116,104,62,67,111,109,109,101,110,116,60,47,116,104,62,60,47,116,114,62,60,47,116,104,101,97,100,62],
        0,
    ) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit("<p>Open a document and record a decision to start this list.</p>"@)
        =~= bs![60u8,112,62,79,112,101,110,32,97,32,100,111,99,117,109,101,110,116,32,97,110,100,32,114,101,99,111,114,100,32,97,32,100,101,99,105,115,105,111,110,32,116,111,32,115,116,97,114,116,32,116,104,105,115,32,108,105,115,116,46,60,47,112,62]);
    assert(cx::scan(
        bs![60u8,112,62,79,112,101,110,32,97,32,100,111,99,117,109,101,110,116,32,97,110,100,32,114,101,99,111,114,100,32,97,32,100,101,99,105,115,105,111,110,32,116,111,32,115,116,97,114,116,32,116,104,105,115,32,108,105,115,116,46,60,47,112,62],
        0,
    ) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit("<p>Each reviewer name is recorded as entered and is not verified.</p>"@)
        =~= bs![60u8,112,62,69,97,99,104,32,114,101,118,105,101,119,101,114,32,110,97,109,101,32,105,115,32,114,101,99,111,114,100,101,100,32,97,115,32,101,110,116,101,114,101,100,32,97,110,100,32,105,115,32,110,111,116,32,118,101,114,105,102,105,101,100,46,60,47,112,62]);
    assert(cx::scan(
        bs![60u8,112,62,69,97,99,104,32,114,101,118,105,101,119,101,114,32,110,97,109,101,32,105,115,32,114,101,99,111,114,100,101,100,32,97,115,32,101,110,116,101,114,101,100,32,97,110,100,32,105,115,32,110,111,116,32,118,101,114,105,102,105,101,100,46,60,47,112,62],
        0,
    ) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit(
        ...
        =~= bs![60u8,112,62,69,97,99,104,32,118,101,114,115,105,111,110,32,108,105,110,107,115,32,116,111,32,116,104,101,32,115,116,111,114,101,100,32,118,101,114,115,105,111,110,32,111,102,32,116,104,101,32,116,101,120,116,32,116,104,97,116,32,116,104,101,32,114,101,118,105,101,119,101,114,32,114,101,97,100,46,60,47,112,62]);
    assert(cx::scan(
        bs![60u8,112,62,69,97,99,104,32,118,101,114,115,105,111,110,32,108,105,110,107,115,32,116,111,32,116,104,101,32,115,116,111,114,101,100,32,118,101,114,115,105,111,110,32,111,102,32,116,104,101,32,116,101,120,116,32,116,104,97,116,32,116,104,101,32,114,101,118,105,101,119,101,114,32,114,101,97,100,46,60,47,112,62],
        0,
    ) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit("<a href=\"../../index.html\">guidelines</a> / <a href=\"index.html\">"@)
        =~= bs![60u8,97,32,104,114,101,102,61,34,46,46,47,46,46,47,105,110,100,101,120,46,104,116,109,108,34,62,103,117,105,100,101,108,105,110,101,115,60,47,97,62,32,47,32,60,97,32,104,114,101,102,61,34,105,110,100,101,120,46,104,116,109,108,34,62]);
    assert(cx::scan(
        bs![60u8,97,32,104,114,101,102,61,34,46,46,47,46,46,47,105,110,100,101,120,46,104,116,109,108,34,62,103,117,105,100,101,108,105,110,101,115,60,47,97,62,32,47,32,60,97,32,104,114,101,102,61,34,105,110,100,101,120,46,104,116,109,108,34,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[124] == u::lit("</a> / records"@),
{
    ...
    assert(u::lit("</a> / records"@) =~= bs![60u8,47,97,62,32,47,32,114,101,99,111,114,100,115]);
    assert(cx::scan(bs![60u8,47,97,62,32,47,32,114,101,99,111,114,100,115], 0) == 0)
        by (compute_only);
        ...
        u::copy_registry()[125] == u::lit("<h1>Decision records</h1>"@),
{
    ...
    assert(u::lit("<h1>Decision records</h1>"@)
        =~= bs![60u8,104,49,62,68,101,99,105,115,105,111,110,32,114,101,99,111,114,100,115,60,47,104,49,62]);
    assert(cx::scan(
        bs![60u8,104,49,62,68,101,99,105,115,105,111,110,32,114,101,99,111,114,100,115,60,47,104,49,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[126] == u::lit("</p>"@),
{
    ...
    reveal_strlit("</p>");
    is_ascii_chars_encode_utf8("</p>"@);
    assert(u::lit("</p>"@) =~= bs![60u8,47,112,62]);
    assert(cx::scan(bs![60u8,47,112,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</p>"@), 0);
    h::fixed(u::lit("</p>"@), inputs, 0, 0);
}
        ...
        ),
{
    ...
    assert(u::lit("<nav class=\"docnav\"><a href=\"index.html\">Guideline index</a></nav>"@)
        =~= bs![60u8,110,97,118,32,99,108,97,115,115,61,34,100,111,99,110,97,118,34,62,60,97,32,104,114,101,102,61,34,105,110,100,101,120,46,104,116,109,108,34,62,71,117,105,100,101,108,105,110,101,32,105,110,100,101,120,60,47,97,62,60,47,110,97,118,62]);
    assert(cx::scan(
        bs![60u8,110,97,118,32,99,108,97,115,115,61,34,100,111,99,110,97,118,34,62,60,97,32,104,114,101,102,61,34,105,110,100,101,120,46,104,116,109,108,34,62,71,117,105,100,101,108,105,110,101,32,105,110,100,101,120,60,47,97,62,60,47,110,97,118,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[128] == u::lit("<span class=\"kw\">"@),
{
    ...
    assert(u::lit("<span class=\"kw\">"@)
        =~= bs![60u8,115,112,97,110,32,99,108,97,115,115,61,34,107,119,34,62]);
    assert(cx::scan(bs![60u8,115,112,97,110,32,99,108,97,115,115,61,34,107,119,34,62], 0) == 0)
        by (compute_only);
        ...
        u::copy_registry()[129] == u::lit("<mark class=\"t"@),
{
    ...
    assert(u::lit("<mark class=\"t"@) =~= bs![60u8,109,97,114,107,32,99,108,97,115,115,61,34,116]);
    assert(cx::scan(bs![60u8,109,97,114,107,32,99,108,97,115,115,61,34,116], 0) == 2)
        by (compute_only);
        ...
        u::copy_registry()[130] == u::lit("<mark>"@),
{
    ...
    assert(u::lit("<mark>"@) =~= bs![60u8,109,97,114,107,62]);
    assert(cx::scan(bs![60u8,109,97,114,107,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[131] == u::lit("</mark>"@),
{
    ...
    reveal_strlit("</mark>");
    is_ascii_chars_encode_utf8("</mark>"@);
    assert(u::lit("</mark>"@) =~= bs![60u8,47,109,97,114,107,62]);
    assert(cx::scan(bs![60u8,47,109,97,114,107,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</mark>"@), 0);
    h::fixed(u::lit("</mark>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[132] == u::lit("<datalist id=\"reviewer-names\">"@),
{
    ...
    assert(u::lit("<datalist id=\"reviewer-names\">"@)
        =~= bs![60u8,100,97,116,97,108,105,115,116,32,105,100,61,34,114,101,118,105,101,119,101,114,45,110,97,109,101,115,34,62]);
    assert(cx::scan(
        bs![60u8,100,97,116,97,108,105,115,116,32,105,100,61,34,114,101,118,105,101,119,101,114,45,110,97,109,101,115,34,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[133] == u::lit("<option value=\""@),
{
    ...
    assert(u::lit("<option value=\""@)
        =~= bs![60u8,111,112,116,105,111,110,32,118,97,108,117,101,61,34]);
    assert(cx::scan(bs![60u8,111,112,116,105,111,110,32,118,97,108,117,101,61,34], 0) == 2)
        by (compute_only);
        ...
        u::copy_registry()[134] == u::lit("\"></option>"@),
{
    ...
    assert(u::lit("\"></option>"@) =~= bs![34u8,62,60,47,111,112,116,105,111,110,62]);
    assert(cx::scan(bs![34u8,62,60,47,111,112,116,105,111,110,62], 2) == 0) by (compute_only);
        ...
        u::copy_registry()[135] == u::lit("</datalist>"@),
{
    ...
    assert(u::lit("</datalist>"@) =~= bs![60u8,47,100,97,116,97,108,105,115,116,62]);
    assert(cx::scan(bs![60u8,47,100,97,116,97,108,105,115,116,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[137] == u::lit(" <a class=\"source\" href=\"../source/"@),
{
    ...
    assert(u::lit(" <a class=\"source\" href=\"../source/"@)
        =~= bs![32u8,60,97,32,99,108,97,115,115,61,34,115,111,117,114,99,101,34,32,104,114,101,102,61,34,46,46,47,115,111,117,114,99,101,47]);
    assert(cx::scan(
        bs![32u8,60,97,32,99,108,97,115,115,61,34,115,111,117,114,99,101,34,32,104,114,101,102,61,34,46,46,47,115,111,117,114,99,101,47],
        0,
    ) == 2) by (compute_only);
        ...
        u::copy_registry()[138] == u::lit("\">PDF</a>"@),
{
    ...
    assert(u::lit("\">PDF</a>"@) =~= bs![34u8,62,80,68,70,60,47,97,62]);
    assert(cx::scan(bs![34u8,62,80,68,70,60,47,97,62], 2) == 0) by (compute_only);
        ...
        u::copy_registry()[141] == u::lit("Source text"@),
{
    ...
    assert(u::lit("Source text"@) =~= bs![83u8,111,117,114,99,101,32,116,101,120,116]);
    assert(cx::scan(bs![83u8,111,117,114,99,101,32,116,101,120,116], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[144] == u::lit("Previous document"@),
{
    ...
    assert(u::lit("Previous document"@)
        =~= bs![80u8,114,101,118,105,111,117,115,32,100,111,99,117,109,101,110,116]);
    assert(cx::scan(bs![80u8,114,101,118,105,111,117,115,32,100,111,99,117,109,101,110,116], 0)
        == 0) by (compute_only);
        ...
        u::copy_registry()[145] == u::lit("<a href=\"../index.html\">Guideline index</a>"@),
{
    ...
    assert(u::lit("<a href=\"../index.html\">Guideline index</a>"@)
        =~= bs![60u8,97,32,104,114,101,102,61,34,46,46,47,105,110,100,101,120,46,104,116,109,108,34,62,71,117,105,100,101,108,105,110,101,32,105,110,100,101,120,60,47,97,62]);
    assert(cx::scan(
        bs![60u8,97,32,104,114,101,102,61,34,46,46,47,105,110,100,101,120,46,104,116,109,108,34,62,71,117,105,100,101,108,105,110,101,32,105,110,100,101,120,60,47,97,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[146] == u::lit("Next document"@),
{
    ...
    assert(u::lit("Next document"@) =~= bs![78u8,101,120,116,32,100,111,99,117,109,101,110,116]);
    assert(cx::scan(bs![78u8,101,120,116,32,100,111,99,117,109,101,110,116], 0) == 0)
        by (compute_only);
        ...
        u::copy_registry()[147] == u::lit("All decision records"@),
{
    ...
    assert(u::lit("All decision records"@)
        =~= bs![65u8,108,108,32,100,101,99,105,115,105,111,110,32,114,101,99,111,114,100,115]);
    assert(cx::scan(
        bs![65u8,108,108,32,100,101,99,105,115,105,111,110,32,114,101,99,111,114,100,115],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[148] == u::lit("<section class=\"stale\">"@),
{
    ...
    assert(u::lit("<section class=\"stale\">"@)
        =~= bs![60u8,115,101,99,116,105,111,110,32,99,108,97,115,115,61,34,115,116,97,108,101,34,62]);
    assert(cx::scan(
        bs![60u8,115,101,99,116,105,111,110,32,99,108,97,115,115,61,34,115,116,97,108,101,34,62],
        0,
    ) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit(
        ...
        =~= bs![60u8,112,32,99,108,97,115,115,61,34,104,108,45,110,111,116,101,34,62,60,108,97,98,101,108,62,60,105,110,112,117,116,32,116,121,112,101,61,34,99,104,101,99,107,98,111,120,34,32,99,108,97,115,115,61,34,104,108,45,116,111,103,103,108,101,34,32,99,104,101,99,107,101,100,62,32,72,105,103,104,108,105,103,104,116,105,110,103,60,47,108,97,98,101,108,62,32,84,114,121,32,104,111,118,101,114,105,110,103,32,97,110,100,32,99,108,105,99,107,105,110,103,32,111,110,32,104,105,103,104,108,105,103,104,116,101,100,32,116,101,114,109,115,32,102,111,114,32,100,105,102,102,101,114,101,110,116,32,108,101,118,101,108,115,32,111,102,32,101,109,112,104,97,115,105,115,46,60,47,112,62]);
    assert(cx::scan(
        bs![60u8,112,32,99,108,97,115,115,61,34,104,108,45,110,111,116,101,34,62,60,108,97,98,101,108,62,60,105,110,112,117,116,32,116,121,112,101,61,34,99,104,101,99,107,98,111,120,34,32,99,108,97,115,115,61,34,104,108,45,116,111,103,103,108,101,34,32,99,104,101,99,107,101,100,62,32,72,105,103,104,108,105,103,104,116,105,110,103,60,47,108,97,98,101,108,62,32,84,114,121,32,104,111,118,101,114,105,110,103,32,97,110,100,32,99,108,105,99,107,105,110,103,32,111,110,32,104,105,103,104,108,105,103,104,116,101,100,32,116,101,114,109,115,32,102,111,114,32,100,105,102,102,101,114,101,110,116,32,108,101,118,101,108,115,32,111,102,32,101,109,112,104,97,115,105,115,46,60,47,112,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[151] == u::lit("<h3>Original passage</h3>"@),
{
    ...
    assert(u::lit("<h3>Original passage</h3>"@)
        =~= bs![60u8,104,51,62,79,114,105,103,105,110,97,108,32,112,97,115,115,97,103,101,60,47,104,51,62]);
    assert(cx::scan(
        bs![60u8,104,51,62,79,114,105,103,105,110,97,108,32,112,97,115,115,97,103,101,60,47,104,51,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[152] == u::lit("<pre class=\"prose\">"@),
{
    ...
    assert(u::lit("<pre class=\"prose\">"@)
        =~= bs![60u8,112,114,101,32,99,108,97,115,115,61,34,112,114,111,115,101,34,62]);
    assert(cx::scan(bs![60u8,112,114,101,32,99,108,97,115,115,61,34,112,114,111,115,101,34,62], 0)
        == 0) by (compute_only);
        ...
        u::copy_registry()[153] == u::lit("</pre>"@),
{
    ...
    assert(u::lit("</pre>"@) =~= bs![60u8,47,112,114,101,62]);
    assert(cx::scan(bs![60u8,47,112,114,101,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[154] == u::lit("<h3>Attempto Controlled English (ACE)</h3>"@),
{
    ...
    assert(u::lit("<h3>Attempto Controlled English (ACE)</h3>"@)
        =~= bs![60u8,104,51,62,65,116,116,101,109,112,116,111,32,67,111,110,116,114,111,108,108,101,100,32,69,110,103,108,105,115,104,32,40,65,67,69,41,60,47,104,51,62]);
    assert(cx::scan(
        bs![60u8,104,51,62,65,116,116,101,109,112,116,111,32,67,111,110,116,114,111,108,108,101,100,32,69,110,103,108,105,115,104,32,40,65,67,69,41,60,47,104,51,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[155] == u::lit("<section class=\"verdict-entry\">"@),
{
    ...
    assert(u::lit("<section class=\"verdict-entry\">"@)
        =~= bs![60u8,115,101,99,116,105,111,110,32,99,108,97,115,115,61,34,118,101,114,100,105,99,116,45,101,110,116,114,121,34,62]);
    assert(cx::scan(
        bs![60u8,115,101,99,116,105,111,110,32,99,108,97,115,115,61,34,118,101,114,100,105,99,116,45,101,110,116,114,121,34,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[156] == u::lit("<h3>Record a decision</h3>"@),
{
    ...
    assert(u::lit("<h3>Record a decision</h3>"@)
        =~= bs![60u8,104,51,62,82,101,99,111,114,100,32,97,32,100,101,99,105,115,105,111,110,60,47,104,51,62]);
    assert(cx::scan(
        bs![60u8,104,51,62,82,101,99,111,114,100,32,97,32,100,101,99,105,115,105,111,110,60,47,104,51,62],
        0,
    ) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit("<p>Does the ACE representation appropriately reflect the original passage?</p>"@)
        =~= bs![60u8,112,62,68,111,101,115,32,116,104,101,32,65,67,69,32,114,101,112,114,101,115,101,110,116,97,116,105,111,110,32,97,112,112,114,111,112,114,105,97,116,101,108,121,32,114,101,102,108,101,99,116,32,116,104,101,32,111,114,105,103,105,110,97,108,32,112,97,115,115,97,103,101,63,60,47,112,62]);
    assert(cx::scan(
        bs![60u8,112,62,68,111,101,115,32,116,104,101,32,65,67,69,32,114,101,112,114,101,115,101,110,116,97,116,105,111,110,32,97,112,112,114,111,112,114,105,97,116,101,108,121,32,114,101,102,108,101,99,116,32,116,104,101,32,111,114,105,103,105,110,97,108,32,112,97,115,115,97,103,101,63,60,47,112,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[158] == u::lit("<form method=\"post\">"@),
{
    ...
    assert(u::lit("<form method=\"post\">"@)
        =~= bs![60u8,102,111,114,109,32,109,101,116,104,111,100,61,34,112,111,115,116,34,62]);
    assert(cx::scan(
        bs![60u8,102,111,114,109,32,109,101,116,104,111,100,61,34,112,111,115,116,34,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[159] == u::lit("<fieldset>"@),
{
    ...
    assert(u::lit("<fieldset>"@) =~= bs![60u8,102,105,101,108,100,115,101,116,62]);
    assert(cx::scan(bs![60u8,102,105,101,108,100,115,101,116,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[160] == u::lit("<legend>Decision</legend>"@),
{
    ...
    assert(u::lit("<legend>Decision</legend>"@)
        =~= bs![60u8,108,101,103,101,110,100,62,68,101,99,105,115,105,111,110,60,47,108,101,103,101,110,100,62]);
    assert(cx::scan(
        bs![60u8,108,101,103,101,110,100,62,68,101,99,105,115,105,111,110,60,47,108,101,103,101,110,100,62],
        0,
    ) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit(
        ...
        =~= bs![60u8,108,97,98,101,108,62,60,105,110,112,117,116,32,116,121,112,101,61,34,114,97,100,105,111,34,32,110,97,109,101,61,34,118,101,114,100,105,99,116,34,32,118,97,108,117,101,61,34,97,112,112,114,111,118,101,100,34,32,114,101,113,117,105,114,101,100,62,32,65,112,112,114,111,118,101,100,60,47,108,97,98,101,108,62]);
    assert(cx::scan(
        bs![60u8,108,97,98,101,108,62,60,105,110,112,117,116,32,116,121,112,101,61,34,114,97,100,105,111,34,32,110,97,109,101,61,34,118,101,114,100,105,99,116,34,32,118,97,108,117,101,61,34,97,112,112,114,111,118,101,100,34,32,114,101,113,117,105,114,101,100,62,32,65,112,112,114,111,118,101,100,60,47,108,97,98,101,108,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[163] == u::lit("</fieldset>"@),
{
    ...
    reveal_strlit("</fieldset>");
    is_ascii_chars_encode_utf8("</fieldset>"@);
    assert(u::lit("</fieldset>"@) =~= bs![60u8,47,102,105,101,108,100,115,101,116,62]);
    assert(cx::scan(bs![60u8,47,102,105,101,108,100,115,101,116,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</fieldset>"@), 0);
    h::fixed(u::lit("</fieldset>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[164] == u::lit("<label for=\"reviewer\">Reviewer name</label>"@),
{
    ...
    assert(u::lit("<label for=\"reviewer\">Reviewer name</label>"@)
        =~= bs![60u8,108,97,98,101,108,32,102,111,114,61,34,114,101,118,105,101,119,101,114,34,62,82,101,118,105,101,119,101,114,32,110,97,109,101,60,47,108,97,98,101,108,62]);
    assert(cx::scan(
        bs![60u8,108,97,98,101,108,32,102,111,114,61,34,114,101,118,105,101,119,101,114,34,62,82,101,118,105,101,119,101,114,32,110,97,109,101,60,47,108,97,98,101,108,62],
        0,
    ) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit(
        ...
        =~= bs![60u8,105,110,112,117,116,32,116,121,112,101,61,34,116,101,120,116,34,32,105,100,61,34,114,101,118,105,101,119,101,114,34,32,110,97,109,101,61,34,114,101,118,105,101,119,101,114,34,32,108,105,115,116,61,34,114,101,118,105,101,119,101,114,45,110,97,109,101,115,34,32,118,97,108,117,101,61,34]);
    assert(cx::scan(
        bs![60u8,105,110,112,117,116,32,116,121,112,101,61,34,116,101,120,116,34,32,105,100,61,34,114,101,118,105,101,119,101,114,34,32,110,97,109,101,61,34,114,101,118,105,101,119,101,114,34,32,108,105,115,116,61,34,114,101,118,105,101,119,101,114,45,110,97,109,101,115,34,32,118,97,108,117,101,61,34],
        0,
    ) == 2) by (compute_only);
        ...
        u::copy_registry()[166] == u::lit("\" required>"@),
{
    ...
    assert(u::lit("\" required>"@) =~= bs![34u8,32,114,101,113,117,105,114,101,100,62]);
    assert(cx::scan(bs![34u8,32,114,101,113,117,105,114,101,100,62], 2) == 0) by (compute_only);
        ...
        u::copy_registry()[167] == u::lit("<label for=\"comment\">Comment (optional)</label>"@),
{
    ...
    assert(u::lit("<label for=\"comment\">Comment (optional)</label>"@)
        =~= bs![60u8,108,97,98,101,108,32,102,111,114,61,34,99,111,109,109,101,110,116,34,62,67,111,109,109,101,110,116,32,40,111,112,116,105,111,110,97,108,41,60,47,108,97,98,101,108,62]);
    assert(cx::scan(
        bs![60u8,108,97,98,101,108,32,102,111,114,61,34,99,111,109,109,101,110,116,34,62,67,111,109,109,101,110,116,32,40,111,112,116,105,111,110,97,108,41,60,47,108,97,98,101,108,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[168] == u::lit("<textarea id=\"comment\" name=\"comment\"></textarea>"@),
{
    ...
    assert(u::lit("<textarea id=\"comment\" name=\"comment\"></textarea>"@)
        =~= bs![60u8,116,101,120,116,97,114,101,97,32,105,100,61,34,99,111,109,109,101,110,116,34,32,110,97,109,101,61,34,99,111,109,109,101,110,116,34,62,60,47,116,101,120,116,97,114,101,97,62]);
    assert(cx::scan(
        bs![60u8,116,101,120,116,97,114,101,97,32,105,100,61,34,99,111,109,109,101,110,116,34,32,110,97,109,101,61,34,99,111,109,109,101,110,116,34,62,60,47,116,101,120,116,97,114,101,97,62],
        0,
    ) == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit("<input type=\"hidden\" name=\"review_sha256\" value=\""@)
        =~= bs![60u8,105,110,112,117,116,32,116,121,112,101,61,34,104,105,100,100,101,110,34,32,110,97,109,101,61,34,114,101,118,105,101,119,95,115,104,97,50,53,54,34,32,118,97,108,117,101,61,34]);
    assert(cx::scan(
        bs![60u8,105,110,112,117,116,32,116,121,112,101,61,34,104,105,100,100,101,110,34,32,110,97,109,101,61,34,114,101,118,105,101,119,95,115,104,97,50,53,54,34,32,118,97,108,117,101,61,34],
        0,
    ) == 2) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit("<input type=\"hidden\" name=\"ledger_sha256\" value=\""@)
        =~= bs![60u8,105,110,112,117,116,32,116,121,112,101,61,34,104,105,100,100,101,110,34,32,110,97,109,101,61,34,108,101,100,103,101,114,95,115,104,97,50,53,54,34,32,118,97,108,117,101,61,34]);
    assert(cx::scan(
        bs![60u8,105,110,112,117,116,32,116,121,112,101,61,34,104,105,100,100,101,110,34,32,110,97,109,101,61,34,108,101,100,103,101,114,95,115,104,97,50,53,54,34,32,118,97,108,117,101,61,34],
        0,
    ) == 2) by (compute_only);
        ...
        u::copy_registry()[171] == u::lit("<input type=\"hidden\" name=\"csrf\" value=\""@),
{
    ...
    assert(u::lit("<input type=\"hidden\" name=\"csrf\" value=\""@)
        =~= bs![60u8,105,110,112,117,116,32,116,121,112,101,61,34,104,105,100,100,101,110,34,32,110,97,109,101,61,34,99,115,114,102,34,32,118,97,108,117,101,61,34]);
    assert(cx::scan(
        bs![60u8,105,110,112,117,116,32,116,121,112,101,61,34,104,105,100,100,101,110,34,32,110,97,109,101,61,34,99,115,114,102,34,32,118,97,108,117,101,61,34],
        0,
    ) == 2) by (compute_only);
        ...
        u::copy_registry()[172] == u::lit("<button>Record decision</button>"@),
{
    ...
    assert(u::lit("<button>Record decision</button>"@)
        =~= bs![60u8,98,117,116,116,111,110,62,82,101,99,111,114,100,32,100,101,99,105,115,105,111,110,60,47,98,117,116,116,111,110,62]);
    assert(cx::scan(
        bs![60u8,98,117,116,116,111,110,62,82,101,99,111,114,100,32,100,101,99,105,115,105,111,110,60,47,98,117,116,116,111,110,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[173] == u::lit("</form>"@),
{
    ...
    assert(u::lit("</form>"@) =~= bs![60u8,47,102,111,114,109,62]);
    assert(cx::scan(bs![60u8,47,102,111,114,109,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[174] == u::lit("<details>"@),
{
    ...
    assert(u::lit("<details>"@) =~= bs![60u8,100,101,116,97,105,108,115,62]);
    assert(cx::scan(bs![60u8,100,101,116,97,105,108,115,62], 0) == 0) by (compute_only);
        ...
        u::copy_registry()[175] == u::lit("<summary>Compiled Prolog ("@),
{
    ...
    assert(u::lit("<summary>Compiled Prolog ("@)
        =~= bs![60u8,115,117,109,109,97,114,121,62,67,111,109,112,105,108,101,100,32,80,114,111,108,111,103,32,40]);
    assert(cx::scan(
        bs![60u8,115,117,109,109,97,114,121,62,67,111,109,112,105,108,101,100,32,80,114,111,108,111,103,32,40],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[176] == u::lit(" lines)</summary>"@),
{
    ...
    assert(u::lit(" lines)</summary>"@)
        =~= bs![32u8,108,105,110,101,115,41,60,47,115,117,109,109,97,114,121,62]);
    assert(cx::scan(bs![32u8,108,105,110,101,115,41,60,47,115,117,109,109,97,114,121,62], 0) == 0)
        by (compute_only);
        ...
        u::copy_registry()[177] == u::lit("<pre>"@),
{
    ...
    reveal_strlit("<pre>");
    is_ascii_chars_encode_utf8("<pre>"@);
    assert(u::lit("<pre>"@) =~= bs![60u8,112,114,101,62]);
    assert(cx::scan(bs![60u8,112,114,101,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("<pre>"@), 0);
    h::fixed(u::lit("<pre>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[178] == u::lit("</details>"@),
{
    ...
    reveal_strlit("</details>");
    is_ascii_chars_encode_utf8("</details>"@);
    assert(u::lit("</details>"@) =~= bs![60u8,47,100,101,116,97,105,108,115,62]);
    assert(cx::scan(bs![60u8,47,100,101,116,97,105,108,115,62], 0) == 0) by (compute_only);
    cx::exact(u::lit("</details>"@), 0);
    h::fixed(u::lit("</details>"@), inputs, 0, 0);
}
        ...
        u::copy_registry()[179] == u::lit("<nav class=\"docnav\">"@),
{
    ...
    assert(u::lit("<nav class=\"docnav\">"@)
        =~= bs![60u8,110,97,118,32,99,108,97,115,115,61,34,100,111,99,110,97,118,34,62]);
    assert(cx::scan(bs![60u8,110,97,118,32,99,108,97,115,115,61,34,100,111,99,110,97,118,34,62], 0)
        == 0) by (compute_only);
        ...
        ),
{
    ...
    assert(u::lit("<a href=\"../../../index.html\">guidelines</a> / <a href=\"../index.html\">"@)
        =~= bs![60u8,97,32,104,114,101,102,61,34,46,46,47,46,46,47,46,46,47,105,110,100,101,120,46,104,116,109,108,34,62,103,117,105,100,101,108,105,110,101,115,60,47,97,62,32,47,32,60,97,32,104,114,101,102,61,34,46,46,47,105,110,100,101,120,46,104,116,109,108,34,62]);
    assert(cx::scan(
        bs![60u8,97,32,104,114,101,102,61,34,46,46,47,46,46,47,46,46,47,105,110,100,101,120,46,104,116,109,108,34,62,103,117,105,100,101,108,105,110,101,115,60,47,97,62,32,47,32,60,97,32,104,114,101,102,61,34,46,46,47,105,110,100,101,120,46,104,116,109,108,34,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[181] == u::lit("</a> / "@),
{
    ...
    reveal_strlit("</a> / ");
    is_ascii_chars_encode_utf8("</a> / "@);
    assert(u::lit("</a> / "@) =~= bs![60u8,47,97,62,32,47,32]);
    assert(cx::scan(bs![60u8,47,97,62,32,47,32], 0) == 0) by (compute_only);
    cx::exact(u::lit("</a> / "@), 0);
    h::fixed(u::lit("</a> / "@), inputs, 0, 0);
}
        ...
        u::copy_registry()[183] == u::lit("</p>\n<!-- "@),
{
    ...
    reveal_strlit("</p>\n<!-- ");
    is_ascii_chars_encode_utf8("</p>\n<!-- "@);
    assert(u::lit("</p>\n<!-- "@) =~= bs![60u8,47,112,62,10,60,33,45,45,32]);
    assert(cx::scan(bs![60u8,47,112,62,10,60,33,45,45,32], 0) == 4) by (compute_only);
    cx::exact(u::lit("</p>\n<!-- "@), 0);
    h::fixed(u::lit("</p>\n<!-- "@), inputs, 0, 4);
}
        ...
        u::copy_registry()[184] == u::lit(" -->"@),
{
    ...
    reveal_strlit(" -->");
    is_ascii_chars_encode_utf8(" -->"@);
    assert(u::lit(" -->"@) =~= bs![32u8,45,45,62]);
    assert(cx::scan(bs![32u8,45,45,62], 4) == 0) by (compute_only);
    cx::exact(u::lit(" -->"@), 4);
        ...
        u::copy_registry()[197] == u::lit("<p>Only GET and POST are supported on this page.</p>"@),
{
    ...
    assert(u::lit("<p>Only GET and POST are supported on this page.</p>"@)
        =~= bs![60u8,112,62,79,110,108,121,32,71,69,84,32,97,110,100,32,80,79,83,84,32,97,114,101,32,115,117,112,112,111,114,116,101,100,32,111,110,32,116,104,105,115,32,112,97,103,101,46,60,47,112,62]);
    assert(cx::scan(
        bs![60u8,112,62,79,110,108,121,32,71,69,84,32,97,110,100,32,80,79,83,84,32,97,114,101,32,115,117,112,112,111,114,116,101,100,32,111,110,32,116,104,105,115,32,112,97,103,101,46,60,47,112,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[198] == u::lit("<p>Only GET is supported on this page.</p>"@),
{
    ...
    assert(u::lit("<p>Only GET is supported on this page.</p>"@)
        =~= bs![60u8,112,62,79,110,108,121,32,71,69,84,32,105,115,32,115,117,112,112,111,114,116,101,100,32,111,110,32,116,104,105,115,32,112,97,103,101,46,60,47,112,62]);
    assert(cx::scan(
        bs![60u8,112,62,79,110,108,121,32,71,69,84,32,105,115,32,115,117,112,112,111,114,116,101,100,32,111,110,32,116,104,105,115,32,112,97,103,101,46,60,47,112,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[202] == u::lit("<p>The requested page does not exist.</p>"@),
{
    ...
    assert(u::lit("<p>The requested page does not exist.</p>"@)
        =~= bs![60u8,112,62,84,104,101,32,114,101,113,117,101,115,116,101,100,32,112,97,103,101,32,100,111,101,115,32,110,111,116,32,101,120,105,115,116,46,60,47,112,62]);
    assert(cx::scan(
        bs![60u8,112,62,84,104,101,32,114,101,113,117,101,115,116,101,100,32,112,97,103,101,32,100,111,101,115,32,110,111,116,32,101,120,105,115,116,46,60,47,112,62],
        0,
    ) == 0) by (compute_only);
        ...
        u::copy_registry()[228] == u::lit("<p>The decision was recorded.</p>"@),
{
    ...
    assert(u::lit("<p>The decision was recorded.</p>"@)
        =~= bs![60u8,112,62,84,104,101,32,100,101,99,105,115,105,111,110,32,119,97,115,32,114,101,99,111,114,100,101,100,46,60,47,112,62]);
    assert(cx::scan(
        bs![60u8,112,62,84,104,101,32,100,101,99,105,115,105,111,110,32,119,97,115,32,114,101,99,111,114,100,101,100,46,60,47,112,62],
        0,
    ) == 0) by (compute_only);
