        ...
        ),
{
    ...
    let committed = match crate::k3_front::trace_custody_exec(
        ...
        asha,
        &front.query.qid,
        Ghost(front.query.file@),
    ) {
        Err(o) => return o,
        Ok(t) => t,
    };
    proof {
        crate::k3_front::front_prefix(before_trace, arena.nodes@, &front);
    }
    ...
    if !crate::k2_walk::ground_root(&arena, derived) || !crate::k2_sort::term_equal(
        &arena,
        derived,
        committed.result,
    ) {
    ...
    match crate::k3_join::result_join_exec(
        &arena,
        &front.loaded.coords,
        digests,
        committed.result,
        ...
        crate::k3_join::EJoin::Ok(nodes) => crate::k3_join::tc_meter_exec(
            front.query.qid.as_slice(),
            nodes.len(),
        ),
    }
}
