...
- `/session-polish` = the polish register's sole consumer: stateless, any-order, zero milestone coupling; assurance tiers, the unit set + scope sources stay fixed — changes there belong to `/session-prompt`.
