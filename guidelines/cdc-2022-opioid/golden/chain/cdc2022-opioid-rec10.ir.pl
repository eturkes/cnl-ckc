...
fact(fact_id(sentence(1),clause(1)),pred('toxicology-testing-clinician',[named('Rec10-clinician')]),source(sentence(1),tokens([2,4]))).
fact(fact_id(sentence(2),clause(1)),pred('acute-pain-clinician',[named('Rec10-peer')]),source(sentence(2),tokens([2,4]))).
rule(rule_id(sentence(3),clause(1)),pred('consider-toxicology-testing',[var(1)]),body([pred('toxicology-testing-clinician',[var(1)])]),source(sentence(3),tokens([2,3]))).
