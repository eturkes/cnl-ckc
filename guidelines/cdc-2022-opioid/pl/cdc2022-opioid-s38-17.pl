...
guideline_document('cdc2022-opioid-s38-17',ace_sha256(e8d7a7031f22e66b4a25643d11c448382c89230053555806eb387b3dcecd5c89),ulex(sha256(ef57ba7180864095bab88b95f11ddb1a2c858593eba715dbfbe874db09506c5b))).
...
guideline_arg('$guideline_id'(context,'cdc2022-opioid-s38-17',3,box(1),[A]),'$guideline_id'(product,'cdc2022-opioid-s38-17',3,ref(4),[A]),3,'$guideline_id'(product,'cdc2022-opioid-s38-17',3,ref(3),[A])) :- guideline_entity(actual,A,clinician,countable), guideline_cardinality(actual,A,na,eq,1).
