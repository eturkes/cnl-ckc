...
guideline_document('cdc2022-opioid-s37-15',ace_sha256(ae70c7cdc676ee26df8d9041885914632dfb31a86d484a7e4da8b81ab5df2856),ulex(sha256('2a4a3e829c919b3dd3b20356e7a69585cfb305c3c57dfb531e3f2c1eb97637b6'))).
...
guideline_pp('$guideline_id'(context,'cdc2022-opioid-s37-15',1,box(1),[A]),'$guideline_id'(product,'cdc2022-opioid-s37-15',1,ref(4),[A]),to,'$guideline_id'(product,'cdc2022-opioid-s37-15',1,ref(3),[A])) :- guideline_entity(actual,A,clinician,countable), guideline_cardinality(actual,A,na,eq,1).
