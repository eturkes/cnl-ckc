...
class LlmSlot:
    ...
    # position discriminator: "expression" (default; current behavior) or
    # "statement" (v0.2.0 code slot — resolved to one or more Python
    # statements and spliced at the surrounding block's indentation).
