...
def base_repo(path, profile="redistributable", docs=None, rights_rows=None, rights_only=False):
    repo = Repo(path)
    repo.write("docs/REFERENCE.md", REFERENCE_DOC)
...
def scenario_committed_state(case_dir):
    ...
    committed_reference = repo.show("docs/REFERENCE.md")
    ...
    repo.write("docs/REFERENCE.md", "dirty reference\n")
    ...
    if bag:
        ...
        add_issue(result, b"dirty reference" not in bag.rel.get("README-dist.md", b""), "working docs/REFERENCE.md leaked")
        ...
        add_issue(result, committed_reference.startswith(b"# Fixture"), "fixture precondition")
    return result
