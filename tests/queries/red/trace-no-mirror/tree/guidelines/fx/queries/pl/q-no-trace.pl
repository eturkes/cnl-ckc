% q-no-trace compiled from ACE question by ace_to_pl question mode; do not edit.
'$guideline_query'(v1,'q-no-trace',ace_sha256(f0fc847f6ad59f03e524f9c0a387dfe763b1af3e727502099de026977bb89615),ulex(none)).
