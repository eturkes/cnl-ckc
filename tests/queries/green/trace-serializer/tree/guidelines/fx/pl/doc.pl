...
guideline_entity(actual,'$guideline_id'(product,doc,1,ref(1),[]),patient,countable) :- \+ (guideline_property(actual,A,blocked,pos), guideline_property(actual,A,excluded,pos)).
