% q-big compiled from ACE question by ace_to_pl question mode; do not edit.
'$guideline_query'(v1,'q-big',ace_sha256('78aaad8e2a574386a38ad952ecb8ea9b3984a6d239c9ca7233b8d59e0aa557a5'),ulex(none)).
