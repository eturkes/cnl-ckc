...
rule(rule_id(sentence(3),clause(1)),pred(r,[var(1)]),body([pred(base,[var(1)]),naf(exception_id(rule(rule_id(sentence(3),clause(1))),literal(2)),pred(p,[var(1)]))]),source(sentence(3),tokens([1,2]))).
