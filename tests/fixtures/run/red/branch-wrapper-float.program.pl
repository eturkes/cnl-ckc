...
clause(rule_id(sentence(3),clause(1),branch(1.5)),pred(recover,[var(1)]),body([pred(patient,[var(1)]),pred(wait,[var(1)])])).
clause(rule_id(sentence(3),clause(1),branch(2)),pred(recover,[var(1)]),body([pred(patient,[var(1)]),pred(sleep,[var(1)])])).
