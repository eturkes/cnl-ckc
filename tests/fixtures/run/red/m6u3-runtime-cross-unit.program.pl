...
document(docid('m6u3-runtime-cross-unit'),source_sha256('7777777777777777777777777777777777777777777777777777777777777777'),ulex(none)).
clause(fact_id(sentence(1),clause(1)),pred(have,[named(a),quantity(integer(70),unit(year))]),body([])).
